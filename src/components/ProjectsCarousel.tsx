      ...
      >
        {projects.map((project) => (
          <motion.div key={project.id} className="flex-shrink-0 w-80">
            <Link to={`/projeto/${project.id}`} className="group block bg-gray-900/50 rounded-lg overflow-hidden h-full transform hover:-translate-y-2 transition-transform duration-300">
              ...
              <div className="p-6 flex flex-col justify-between flex-grow">
                <div>
                  ...
                  <p className="text-gray-400 mb-4 line-clamp-2 text-left">{project.description}</p>
                </div>
                <div className="flex items-center font-semibold text-blue-400 group-hover:text-blue-300 transition-colors mt-4">
                  Ver projeto
